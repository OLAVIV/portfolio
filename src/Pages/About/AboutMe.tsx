...
const AboutMe: React.FC<AboutMeProps> = () => {
  return (
    <div>
        <div>
            <p className={styles.otsikko}>About Me</p>
            ...
            <p className={styles.aboutme}>I am currently studying at Varia Myyrmäki , ive studie for about one and a half years by now.</p>
            ...
            <p className={styles.aboutme}>I studied the basics Unity, and C# scripting quite thoroughly, but there is always something new to learn.</p>
        </div>
